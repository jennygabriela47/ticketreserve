...
<body>
	...
	<div align="center">
	<h1><b>Actualiza tus Datos</b> </h1>
		<form>
			
				<table>
					<tr>
						<td class="td">Nombres: </td>
						<td class="td"><input type="text" name="nombre" class="campoTexto" disabled></td>
					</tr>
					<tr>
						<td class="td">Apellidos: </td>
						<td class="td"><input type="text" name="apellido" class="campoTexto" disabled></td>
					</tr>
					
					<tr>
						<td class="td">Correo Electrónico: </td>
						<td class="td"><input type="text" name="direccion" class="campoTexto" disabled></td>
					</tr>
					<tr>
